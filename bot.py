...
TOKEN="1591700958:AAF0Sp3MGkNnTTcUimsGVVOtAGPnl_D81t8"
...
def webhook():
    ...
    #create update object json-format request data
...
bot=Bot(TOKEN)
try:
    bot.set_webhook("https://warm-waters-11825.herokuapp.com/" + TOKEN)
